...
type CommonTracer interface {
	...
	// Most tracers return a single spec, but some (like tpinjector) may return multiple.
	...
	// Single-spec tracers return []any{&p.bpfObjects}, multi-spec return multiple objects.
	BpfObjects() []any
...
type Tracer interface {
	...
	// Single-spec tracers return []map[string]any{constants}, multi-spec return one map per spec.
